...
class tl_page_l10n extends tl_page {
    ...
    public function listPagesL10n($arrRow, $strLabel, DataContainer $dc=null, $imageAttribute='', $blnReturnImage=false, $blnProtected=false) {
        ...
        $strNewsI18nl10nParam = 'do=news&table=tl_page_i18nl10n';
        ...
        (
            ...
            'newsEditUrl' => $this->addToUrl('do=news&table=tl_page&act=edit&id=' . $arrRow['id']),
        ...
        $strLabel = preg_replace('@(?<=</a>)$@', I18nl10n::vnsprintf($strLabelL10n, $templateValues), $strLabel);

...
(
    'Seitensprachen',
    'Definiere mit <a target="_blank" href="http://en.wikipedia.org/wiki/List_of_ISO_639-1_codes">'
    . '<em>validen ISO 639-1</em></a> Sprach-Codes (z.B. <em>en</em> oder <em>de</em>) die verfügbaren '
    . 'Sprachen der Website. Die Standardsprache <strong>muss</strong> ebenfalls definiert sein!'
);
...
(
    ...
    'Die aktuell gewählte Sprache wird für die URL-Ausgabe dem Alias hinzugefügt (z.B. home &gt; home.en). '
    . 'Soll ein Suffix angezeigt werden, wird es nach dem Sprachkürzel angefügt (z.B. home.en.html). '
    . 'Hinweis: Diese Option wirkt sich nur auf die Ausgabe, nicht aber auf das Seitenalias selber aus!'
);

$GLOBALS['TL_LANG']['tl_settings']['i18nl10n_addLanguageToUrl'] = array
(
    'Die Sprache zur URL hinzufügen',
    'Fügt den Sprachkürzel als ersten parameter der URL hinzu (z.B. <em>http://www.meine-website.com/en/</em>) und ist die Modulalternative zur gleichnamigen Contao Einstellung. '
    . 'Hinweis!: Bei der Verwendung dieser Option <em>muss</em> neben der gleichnamigen Contao Einstellung auch <em>"'
